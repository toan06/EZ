...
<span style="color: red">__If the above code doesn't work__
Copy the entire [this code](https://raw.githack.com/toan06/EZ/main/fb/tools/bot/repeat.js) _And paste in the browser URL_ </span>
------------------------------------
